...
参道、道、階段、出入口及び橋は通行空間として中央を空けます。石灯籠、灯具、柱、標識及び像のような固定設備は、背景で確立された道端又は通行空間の外側へ保持し、人物を目立たせるために参道中央へ移動しません。固定設備との相互作用をShotが要求する場合は、設備を人物の前へ出すのではなく、人物が道の中心線を外れて道端の設備へ近づきます。
